...
<head>
<title>PHPExeCool</title>
<meta name="author" content="Sarfraz Ahmed (http://sarfraznawaz.wordpress.com)">
...
<body>
   <div class="header">
      <div class="right" id="buttons">
         <input type="button" class="btn btn-blue" value="Execute" id="btnRun" title="Ctrl+Enter" />
      ...
      <h1><a href="index.php"><img class="left" src="img/terminal.png" align="absmiddle" width="30" height="30" alt=""></a>&nbsp;PHPExeCool - PHP Code Runner</h1>
   </div>
